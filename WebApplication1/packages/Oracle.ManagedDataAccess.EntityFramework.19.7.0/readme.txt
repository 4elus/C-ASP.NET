Oracle.ManagedDataAccess.EntityFramework Nuget Package Version 19.7.0 README
============================================================================
...
New Features
============
1. Entity Framework 6.4 Certification
ODP.NET Entity Framework 19.6.0 and higher is certified for Entity Framework 6.4.


Bug Fixes since Oracle.ManagedDataAccess.EntityFramework NuGet Package 19.6.0
=============================================================================
Bug 29597674 : USE IDENTITY COLUMNS BY DEFAULT IF THE DB IS 12.1 OR HIGHER
...
1. Un-GAC any existing ODP.NET for Entity Framework 19.3 versions you have installed. For example, if you 
plan to use only the ODP.NET, Managed Driver for Entity Framework, only un-GAC existing managed ODP.NET for
Entity Framework 19.3 versions then.
